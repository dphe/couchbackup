...
describe('#unit Perform backup using shallow backup', function() {
  ...
  it('should perform a shallow backup', function(done) {
    var couch = nock(dbUrl)
      ...
      // batch 2
      .post('/_all_docs', {limit: 3, include_docs: true, startkey: 'badger\0'})
      .query({include_docs: true})
      .reply(200, JSON.parse(fs.readFileSync('./test/fixtures/animaldb_all_docs_2.json', 'utf8')))
      // batch 3
      .post('/_all_docs', {limit: 3, include_docs: true, startkey: 'kookaburra\0'})
      .query({include_docs: true})
      .reply(200, JSON.parse(fs.readFileSync('./test/fixtures/animaldb_all_docs_3.json', 'utf8')))
      // batch 4
      .post('/_all_docs', {limit: 3, include_docs: true, startkey: 'snipe\0'})
      .query({include_docs: true})
  ...
  it('should fail to perform a shallow backup on fatal error', function(done) {
    var couch = nock(dbUrl)
      // batch 1
      .post('/_all_docs', {limit: 3, include_docs: true}).query({include_docs: true})
      .reply(200, JSON.parse(fs.readFileSync('./test/fixtures/animaldb_all_docs_1.json', 'utf8')))
      // batch 2
      .post('/_all_docs', {limit: 3, include_docs: true, startkey: 'badger\0'}).query({include_docs: true})
      .reply(200, JSON.parse(fs.readFileSync('./test/fixtures/animaldb_all_docs_2.json', 'utf8')))
      // batch 3 - fatal error
      .post('/_all_docs', {limit: 3, include_docs: true, startkey: 'kookaburra\0'}).query({include_docs: true})
